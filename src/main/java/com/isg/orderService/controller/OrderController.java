...
import com.isg.orderService.config.ProductResourceFeign;
import com.isg.orderService.model.*;
import com.isg.orderService.repository.OrderDetailRepository;
...
public class OrderController {
    ...
    public void deleteOrder(@PathVariable("id") String id) {
        ...
        for (int i = 0; i < details.size(); i++) {
//            productResourceFeign.updateQuantity(details.get(i).getProduct(), details.get(i).getQuantity(), false);
        }
        //delete order
...
//        productResourceFeign.updateQuantity(orderDetail.get().getProduct(), orderDetail.get().getQuantity(), false);
