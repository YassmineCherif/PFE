package com.isg.CategorieService.controller;


import com.isg.CategorieService.config.ProductResourceFeign;
import com.isg.CategorieService.exceptions.CategoryNotFoundException;
import com.isg.CategorieService.model.*;
import com.isg.CategorieService.repository.CategoryRepoitory;
import com.isg.CategorieService.repository.SubCategoryRepository;
...
public class CategoryController {
    ...
    @Autowired
    private ProductResourceFeign iProduct;
    ...
    public List<Statistics> DashboradProductsByCategories() {
        ...
        for (int i = 0; i < categories.size(); i++) {
            List<Product> products = iProduct.getByCategory(categories.get(i).getId());
    ...
    public Optional<Category> getCategory(@PathVariable("id") String id) {
        ...
        List<Product> products = iProduct.getByCategory(id);
    ...
    public Optional<Category> getCategory(@PathVariable("id") String id, @PathVariable("page") int page, @PathVariable("sort") String sort, @PathVariable("dir") String dir) {
        ...
        Optional<Category> category = categoryRepository.findById(id);
        List<SubCategory> subCategories = subCategoryRepository.findByCategory(id);
        Object productsPage = iProduct.getByCategory(id, page, sort, dir);
    ...
    public List<Category> filterBykeyWord(@PathVariable("keyWord") String keyWord) {
        ...
        List<String> ids = iProduct.filter(keyWord);
        ...
        for (int i = 0; i < categories.size(); i++) {
            Object productsPage = iProduct.filterBykeyWordAndPageAndCategory(keyWord, categories.get(i).getId(), 0);
    ...
    public Optional<Category> filterBykeyWordAndCategory(@PathVariable("keyWord") String keyWord, @PathVariable("id") String id, @PathVariable("page") int page) {
        ...
        Optional<Category> category = categoryRepository.findById(id);
        List<SubCategory> subCategories = subCategoryRepository.findByCategory(id);
        Object productsPage = iProduct.filterBykeyWordAndPageAndCategory(keyWord, id, page);
        category.get().setProductsPage(productsPage);
        category.get().setSubCategories(subCategories);
        return category;
    }
    ...
    public Optional<SubCategory> getSubCategory(@PathVariable("id") String id) {
        ...
        List<Product> products = iProduct.getBySubCategory(id);
    ...
    public Optional<SubCategory> getSubCategory(@PathVariable("id") String id, @PathVariable("page") int page, @PathVariable("sort") String sort, @PathVariable("dir") String dir) {
        ...
        Optional<SubCategory> subCategory = subCategoryRepository.findById(id);
        Object productsPage = iProduct.getBySubCategoryByPage(id, page, sort, dir);
